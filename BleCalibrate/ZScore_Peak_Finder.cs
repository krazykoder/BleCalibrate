...
{
    public class ZScore_Peak_Finder 
    {
        public ZScoreOutput StartAlgo(List<double> input, int lag, double threshold, double influence)
        {
            // init variables!
        ...
        internal object StartAlgo(List<int> input, int lag, double threshold, double influence)
        {
